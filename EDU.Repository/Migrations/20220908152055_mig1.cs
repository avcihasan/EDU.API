        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adverts_Educations_EducationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Registers_Adverts_AdvertId",
                        column: x => x.AdvertId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentOfClassrooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentOfClassrooms_Classrooms_ClassroomId",
                        column: x => x.ClassroomId,
                        principalTable: "Classrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentOfClassrooms_Users_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherOfClassrooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherOfClassrooms_Classrooms_ClassroomId",
                        column: x => x.ClassroomId,
                        principalTable: "Classrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherOfClassrooms_Users_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registers_AdvertId",
                table: "Registers",
                column: "AdvertId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentOfClassrooms_ClassroomId",
                table: "StudentOfClassrooms",
                column: "ClassroomId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentOfClassrooms_StudentId",
                table: "StudentOfClassrooms",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherOfClassrooms_ClassroomId",
                table: "TeacherOfClassrooms",
                column: "ClassroomId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherOfClassrooms_TeacherId",
                table: "TeacherOfClassrooms",
                column: "TeacherId");
